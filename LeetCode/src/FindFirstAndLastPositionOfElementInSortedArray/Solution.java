...
public class Solution {
    ...
    private static int binarySearchTargetLeft(int[] nums, int start, int end, int target) {
    ...
    // Ищем индекс mid такой, что: nums[mid+1] > target && nums[mid] == target
    private static int binarySearchTargetRight(int[] nums, int start, int end, int target) {
